...
# included (checked by if statement with .include?) the item I was looking to delete I called .delete on the source hash structure and used the current key as the input
